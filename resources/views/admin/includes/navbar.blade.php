        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{route('addCategory')}}">Add Category</a></li>
                        <li><i class="fa fa-table"></i><a href="{{route('category.index')}}">View Category</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{route('addProduct')}}">Add Product</a></li>
                        <li><i class="fa fa-table"></i><a href="{{route('product.index')}}">View Product</a></li>
                    </ul>
                </li>
