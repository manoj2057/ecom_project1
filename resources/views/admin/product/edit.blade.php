...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <form action="{{route('updateProduct',$product->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="name" name="product_name" placeholder="Enter category name" class="form-control" value={{ $product->product_name }}></div>
                </div>
                <div class="row form-group">
                    ...
                    <img src="{{asset('public/uploads/products/'.$product->image)}}" id="one" style="width: 100px">
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="status" class=" form-control-label">Status</label></div>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="checkbox" name="status" {{ $product->status == 'active' ? 'checked' : '' }} data-toggle="toggle" data-size="xs" value="1">                         <label>Active</label>
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="name" class=" form-control-label">Price<span class="text-danger">*</label></div>
                    <div class="col-12 col-md-9"><input type="number" id="price" name="price" placeholder="Enter price" class="form-control" value="{{ $product->price}}"></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="excerpt" class=" form-control-label">Excerpt<span class="text-danger">*</label></div>
                    <div class="col-12 col-md-9"><textarea name="excerpt" id="excerpt" cols="10" rows="3" class="form-control">{{ $product->excerpt }}</textarea></div>
                </div>
